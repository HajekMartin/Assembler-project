...
;**********************************************************************
	...
	btfsc	IOCAF,4		;preruseni od BT1(RA4)?
	call	BT1Int		
	bcf	IOCAF,4		;vynulovat priznak od BT1(RA4)
	
	btfsc	IOCAF,5		;preruseni od BT2(RA4)?
	call	BT2Int		
...
BT1Int	bcf	IOCAF,4		;vynulovat priznak od BT2(RA5)
	movlb	.7		;Banka1 s ADC
	movlw	b'00011001'	;je to tedy od BT2...
	return
